                ...
                <div class="w-full mt-16 md:mt-0 md:w-2/5">
                    <form wire:submit="register">
                        <div
                            ...
                            <h3 class="mb-6 text-2xl font-medium text-center">Register your Account</h3>
                            <input type="text" name="name" wire:model="fullname" id="email"
                                   class="block w-full px-4 py-3 mb-2 border border-gray-200 rounded-lg focus:ring focus:ring-primary focus:outline-none"
                                   data-rounded="rounded-lg" data-primary="primary" placeholder="Fullname">
                            @error('fullname') <div class="text-red-600 mb-2">{{ $message }}</div>  @enderror
                            ...
                            @error('email') <div class="text-red-600 mb-2">{{ $message }}</div>  @enderror
                            ...
                            <div class="block">
                                <button class="w-full px-3 py-4 font-medium text-white bg-secondary rounded-lg"
                                        data-primary="blue-600" data-rounded="rounded-lg">Register Now
                                </button>
                            </div>
